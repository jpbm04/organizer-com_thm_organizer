 ...
 * richtet sich nach den in den Erweiterungen angegebenen Abhaengigkeiten.
 */
...
foreach ($allUnsortedExt as $ext)
{
	...
	{
		echo "Bei der Erweiterung '$exml->name' wurden keine Abhaengigkeiten ermittelt." . PHP_EOL;
	}
}
//--------------------------------------------------------------------------------------------------------------------------
//-----------------------------------------------                 4              -------------------------------------------
...
echo PHP_EOL . 'Alle Erweiterungen die nach der Sortierung zur Verfuegung stehen.' . PHP_EOL;
